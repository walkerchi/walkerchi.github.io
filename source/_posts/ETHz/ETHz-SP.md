...
![Global Galerkin Equivalent Architecture with positional encoding frequency 8. The right is the predicted Galerkin matrix while the left is the ground truth Galerkin matrix](gea/global/K/L=8.png)
<center>
